...
const unsigned long sending_interval = 600 * 1000;

#define INIT_CHAR 0x55
#define INIT_BAUD 2400
#define INIT_SIZE 504
...
void sendData() {
  // Send data to MQTT
  client.publish(mqtt_topic, (const uint8_t*) response.data, (unsigned int) response.length, true);
}
